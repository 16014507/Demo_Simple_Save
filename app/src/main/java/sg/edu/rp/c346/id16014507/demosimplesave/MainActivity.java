package sg.edu.rp.c346.id16014507.demosimplesave;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        super.onPause();
        //Step 1: Obtain the SharedPrefrences instance
        SharedPreferences prefs = getPreferences(MODE_PRIVATE);
        //Step 2: Create a SharedPreferences Editor by callig edit()
    ...
    protected void onResume() {
        ...
        SharedPreferences prefs = getPreferences(MODE_PRIVATE);
        //Step 2: Retrieve the save data from the SharedPreferences
